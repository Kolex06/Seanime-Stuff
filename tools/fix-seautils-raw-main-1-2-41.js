...
const workflowPath = '.github/workflows/seautils-raw-main-1-2-41.yml';
const scriptPath = 'tools/fix-seautils-raw-main-1-2-41.js';
...
readme = readme.replace(/1\.2\.38|1\.2\.39|1\.2\.40/g, '1.2.41');
readme = readme.replace(/https:\/\/raw\.githubusercontent\.com\/Kolex06\/Seanime-Stuff\/refs\/heads\/main\/plugins\/SeaUtils-Kolex06-Version\.json/g, manifestUri);
