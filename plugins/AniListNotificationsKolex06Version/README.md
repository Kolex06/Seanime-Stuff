...
### 1.0.18
- Separates the top-right popup close button from the clickable notification area so the X only closes the popup.
...
### 1.0.15
- added `+` for when you have more then `99` Notifactions 
