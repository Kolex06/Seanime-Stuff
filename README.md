...
| --- | --- | --- | --- |
| SeaUtils Kolex06-Version | 1.2.47 | `SeaUtils-Kolex06-Version` | Utility plugin for Seanime UI improvements, marketplace/full catalog controls, carousels, sub/dub badges, and tray preferences. |
